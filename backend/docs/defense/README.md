...
| `VioNER_Defense_Slides_study_guide.md` | Slide-by-slide study companion to `VioNER_Defense_Slides.pptx`. Every one of the 22 slides has a verbatim delivery script, the deeper "why this slide", key terms and numbers, anticipated panel questions with prepared answers, and a pivot to the next slide. Plus pacing target across all 22 slides and a defense-day calibration note. |
